                ...
                if res_detail.status_code == 200:
                    ...
                    if not routes:
                        ...
                        for route in routes:
                            ...
                            # Zeige die Karten in einem schmaleren Layout an, damit es auf dem PC gut aussieht
...
# --- FAHRER DASHBOARD ---
    ...
    try:
        ...
        st.error(f"Fehler bei der Verbindung zum Server: {e}")import streamlit as st
import requests
import pandas as pd
from datetime import datetime, timedelta
