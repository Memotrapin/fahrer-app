...
# --- ADMIN DASHBOARD ---
    ...
    for d in drivers:
        ...
        try:
            ...
            admin_data.append({"Fahrer-ID": d['id'], "Name": d['name'], "Touren": len(routes), "Gesamt Stopps": total, "Geliefert": done, "Offen": total - done, "Status": "Aktiv" if total > 0 else "Leer"})
        except: continue
    ...
    with col_details:
        if event.selection.rows:
            ...
            except: st.error("Fehler beim Laden der Details")
